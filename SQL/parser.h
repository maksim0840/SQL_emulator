...
private:
    ...
    int expect_value(); // читает число до любого не цифрового символа
    ...
    std::string read_int32_str();
    std::string read_bool_str();
    ...
    int expect_label_size(Sql::ColumnLabel* label);
